    ...
    return (
        ...
        >
            ...
            {selectedOption && (
                ...
                >
                    <h2 style={{ marginBottom: "15px", color: "#255799" }}>{selectedOption} Details</h2>

                    <div style={{ marginBottom: "10px" }}>
                        <label style={{ display: "block", marginBottom: "5px" }}>Origin</label>
                        <Autocomplete
                            onLoad={(autocompleteInstance) => (autocompleteOriginRef.current = autocompleteInstance)}
            ...
            >
                <h2 style={{ marginBottom: "15px", color: "#255799" }}>Personality Preferences</h2>
                ...
                {[
                    ...
                    { trait: "Snacks/Meal", label: "Snacks/Meal" },
                ].map(({ trait, label }) => (
                    <div key={trait} style={{ marginBottom: "20px" }}>
                        ...
                        >
                            {label}: {getCategory(personalityTraits[trait as keyof typeof personalityTraits] as number)}
                        </label>
                        <input
                            type="range"
                            min="0"
